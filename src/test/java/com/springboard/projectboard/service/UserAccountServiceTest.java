...
class UserAccountServiceTest {
    ...
    @DisplayName("회원 정보를 입력하면, 새로운 회원정보를 저장하여 가입시키고 해당 회원 데이터를 리턴한다.")
    @Test
    void givenUserParam_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("eongyu");
        UserAccount savedUserAccount = createSigningUpUserAccount("eongyu");
